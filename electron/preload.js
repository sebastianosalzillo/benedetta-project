 ...
 * @property {(settings: Object) => IpcInvokeResult} saveUserSettings Save user identity settings.
 * @property {(settings: Object) => IpcInvokeResult} saveSoulSettings Save avatar soul settings.
 * @property {(settings: Object) => IpcInvokeResult} saveIdentitySettings Save operational identity settings.
 * @property {() => IpcInvokeResult} getDebugLogs Get recent debug timeline logs.
 * @property {() => IpcInvokeResult} clearDebugLogs Clear debug logs.
...
const screenBridge = rendererScreen === 'avatar'
  ...
  : rendererScreen === 'canvas'
    ...
    : {
        ...
        saveUserSettings: (settings) => ipcRenderer.invoke('settings:save-user', settings),
        saveSoulSettings: (settings) => ipcRenderer.invoke('settings:save-soul', settings),
        saveIdentitySettings: (settings) => ipcRenderer.invoke('settings:save-identity', settings),
